...
        debug: false,
        grey: false,
        logURL: "https://promreport.crm2.qq.com/wpa/r.gif"
    };
    var d = function () {
        var p = /(^[\s?]+)|([\s?]+$)/g;
...
            this.url = "https://isdspeed.qq.com/cgi-bin/r.cgi?flag1=" + t + "&flag2=" + s + "&flag3=" + v + "&";
            this.p0 = +new Date();
            this.points = [this.p0];
            this.rate = u || 1
        };
...
        }
    });
    h("api.require", "globalSettings,lang.each,lang.trim,lang.typeEnhance,util.pubSub,util.combo,util.getRequireList", function (
        s) {
...
    "wty": "1",
    "kfuin": "938078298",
    "nameAccount": "4009698280",
    "type": "1",
    "sv": "4",
    "title": "",
    "aty": "0",
    "a": "0",
    "ws": "https:\/\/www.wangdaiwin.com\/",
    "btn1": "\u8425\u9500QQ\u4ea4\u8c08",
    "btn2": "",
    "fsty": "0",
    "fposX": "0",
